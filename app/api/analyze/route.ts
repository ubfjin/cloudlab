...
2. 사용자의 답안을 다음 기준으로 채점하여 'score'를 부여하라:
   ...
   - [판단 근거 (Visual Only)] 사용자가 "판단 근거"에 구름의 **시각적 특징(모양, 색, 질감, 높이 등)**을 올바르게 설명하고 있으면 +2점. (설명이 틀렸거나 시각적 특징이 없으면 0점 또는 1점)
   - [과학적 추론 (Atmospheric)] 사용자가 "과학적 추론"에 **기상 현상**을 논리적으로 추론했으면 +1점. (단, 사용자 입력이 '없음' 이거나 비어있는 경우, 또는 추론 내용이 틀린 경우에는 절대 점수를 주지 말고 반드시 0점을 부여하라.)
